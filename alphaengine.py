...
class AlphaEngine:
    """Main orchestrator for AlphaEngine."""

    def __init__(self, verbose: bool = False):
        self.verbose = verbose
        self.threshold = float(os.getenv("THRESHOLD", "0.75"))
        self.core = AlphaEngineCore(threshold=self.threshold, verbose=verbose)
    ...
    def run(self) -> bool:
        try:
            self.logger.info("Starting AlphaEngine processing pipeline")
